...
// --- 1. Leitcode parsen (mit Cache-Reset) ---
...
function removePackage(index) {
    ...
    renderPackageList();
    resetResult(); // Ergebnis zurücksetzen bei Änderung
}
...
async function checkPackstationCompatibility() {
    ...
    // NEU: Eindeutige Correlation ID mit Zeitstempel
    ...
    // Payload erstellen mit eindeutiger Correlation ID
    const payload = {
